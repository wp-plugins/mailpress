...
<div class='wrap'>
	...
	<div id='example'>
		<ul class="tablenav<?php if (!$mp_general) echo ' ui-tabs-nav'; ?>">
			<li <?php if ((!$mp_general) || ($mp_tab=='0')) echo " class='ui-tabs-selected'"; ?>><a href='#fragment-1'><span><?php _e('General','MailPress'); ?></span></a></li>
<?php
if ($mp_general)
{
?>
			<li <?php if ($mp_tab==1) echo " class='ui-tabs-selected'"; ?>><a href='#fragment-2'><span><?php echo apply_filters('MailPress_Swift_Connection_type','SMTP'); ?></span></a></li>
			<li <?php if ($mp_tab==3) echo " class='ui-tabs-selected'"; ?>><a href='#fragment-4'><span><?php _e('Test'    ,'MailPress'); ?></span></a></li>
<?php
