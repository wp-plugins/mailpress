...
<?php if ( 'sent' != $url_parms['status'] ): ?>
				<?php if (current_user_can('MailPress_send_mails')) : ?><input type='submit' value="<?php _e('Send','MailPress'); ?>" 	name='sendit'	  class='button-secondary' /><?php endif; ?>
				<?php if (current_user_can('MailPress_delete_mails')) : ?><input type='submit' value="<?php _e('Delete','MailPress'); ?>" 	name='deleteit'     class='button-secondary' /><?php endif; ?>
<?php else : ?>
				<?php if (current_user_can('MailPress_delete_mails')) : ?><input type='submit' value="<?php _e('Delete','MailPress'); ?>" 	name='deleteit'     class='button-secondary' /><?php endif; ?>
<?php endif; ?>
			</div>
...
?>
					<th scope="col"<?php echo "id=\"$mail_column_key\""; echo $class; echo $style?>><?php echo $column_display_name; ?></th>
<?php } ?>
<!--

    					<th scope='col' class='check-column'><input type='checkbox'<?php echo $disabled;?>/></th>
