...
if (isset($_GET['revision'])) {$message  .= sprintf( __('Mail restored to revision from %s','MailPress'), mp_mail_revision_title( (int) $_GET['revision'], false ) ); $err   = true; }
		...
		<div id='poststuff'>
			<div class='submitbox' id='submitpost'>
				...
				<p class='submit'>
					...
					<input type='submit' name='send' id='publish'   class='button' 			 value="<?php _e('Send','MailPress'); ?>" />
<?php if ($delete_url) : ?>
