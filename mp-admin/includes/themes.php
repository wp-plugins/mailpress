...
if ( isset( $_GET['pagenum'] ) ) $page = absint( $_GET['pagenum'] );
if ( empty($page) ) $page = 1;

$start = $offset = ( $page - 1 ) * $per_page;

$page_links = paginate_links( array('base' => add_query_arg( 'pagenum', '%#%' ) . '#themenav',
						'format' => '',
...
<?php
	 		if ( !empty($theme_name) ) :
				...
				$preview_link 	= clean_url(add_query_arg( array('action' => 'theme-preview', 'template' => $template, 'stylesheet' => $stylesheet, 'TB_iframe' => 'true', 'width' => 600, 'height' => 400 ), MP_Action_url ));
