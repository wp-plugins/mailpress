...
$messages[2] = __('Cron deleted.', MP_TXTDOM);
$messages[3] = __('Cron updated.', MP_TXTDOM);
$messages[4] = __('Cron NOT added.', MP_TXTDOM);
$messages[5] = __('Cron NOT updated.', MP_TXTDOM);
$messages[6] = __('Crons deleted.', MP_TXTDOM);
$messages[7] = __('Cron executed.', MP_TXTDOM);
$messages[8] = __('Cron NOT executed.', MP_TXTDOM);
...
<?php 	if ( $page_links ) echo "						<div class='tablenav-pages'>$page_links</div>"; ?>
						<div class='alignleft actions'>
							...
							<input type='hidden' name='page' value='<?php echo MailPress_page_wp_cron; ?>' />
						</div>
						<br class='clear' />
					</div>
					<div class="clear"></div>
