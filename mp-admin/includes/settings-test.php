								...
								<table class='form-table'>
									<tr>
										...
										<td> 
											...
											<input type='text' size='25' name='test[toemail]' value='<?php echo $test['toemail']; ?>' <?php echo $style; ?>/>
											&nbsp;&nbsp;&nbsp;
											<?php _e('Name : ','MailPress'); ?> 
											<input type='text' size='25' name='test[toname]' value="<?php echo htmlentities(stripslashes($test['toname']),ENT_QUOTES); ?>" />
										</td>
									</tr>
									<tr>
										<th scope='row'>
...
<!--
											&nbsp;&nbsp;
											<input name='test[asdraft]' type='checkbox' <?php echo( ($test['asdraft']==true) ? "checked='checked'" : ''); ?> />
											&nbsp;
											<?php _e('as draft','MailPress'); ?>
-->
											<br/>
								...
								<p class='submit'>
									...
									<input type='submit' name='Test'   value='<?php  _e('Save &amp; Test','MailPress'); ?>' />
								</p>
							</form>
						</div>