...
class MP_import_xmlsample extends MP_Import_abstract
{
	function __construct() 
	{
		$this->importer 		= 'xmlsample';
		$this->importer_text 	= __('Import your <strong>xmlsample</strong> file.', 'MailPress');
		$this->importer_header 	= __('Import XML sample', 'MailPress') ;
		parent::__construct();
	}
