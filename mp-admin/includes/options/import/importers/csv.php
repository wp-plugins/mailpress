...
class MP_import_csv extends MP_Import_abstract
{
	function __construct() 
	{
		$this->importer 		= 'csv';
		$this->importer_text 	= __('Import your <strong>csv</strong> file.', 'MailPress');
		$this->importer_header 	= __('Import Csv', 'MailPress');
		parent::__construct();
	}
