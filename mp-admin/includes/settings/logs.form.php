...
<?php self::logs_sub_form('general', $logs, __('Mails', 'MailPress') , __('Mailing log', 'MailPress') , __('(for <b>ALL</b> mails send through MailPress)', 'MailPress'), __('Number of Log files : ', 'MailPress')); ?>
