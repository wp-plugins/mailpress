...
class MailPress_autoresponder extends MP_abstract
{
...
// for tracking events to autorespond to
		include(MP_TMP . 'mp-includes/mp_autoresponder/options.php');
		$x = array();
...
// for link on plugin page
	public static function plugin_action_links($links, $file)
	{
		...
		$settings_link = '<a href="' . MailPress_settings . '#fragment-4">' . __('Settings') . '</a>';
...
// for load admin page
	...
	public static function mp_action_add_atrspndr() 
	{
		...
		if ( !$autoresponder || (!$autoresponder = MP_Autoresponders::get( $autoresponder )) ) 	die('0');
	...
	public static function mp_action_delete_atrspndr() 
	{
		...
		self::require_class('Autoresponders');
		die( MP_Autoresponders::delete($id) ? '1' : '0' );
	}
...
<?php self::select_option($_autoresponders, false); ?>
					</select>
				</td>
...
" . self::select_option($_autoresponders, $entry['term_id'], false) . "
					</select>
					<div class='submit'>
