...
if (isset($mp_general['wp_mail']))
{
	switch (true)
	{ 	
		case (version_compare($wp_version, '3.0', '>=')) :
			include (MP_ABSPATH . 'mp-includes/wp_pluggable.3.0.php');
		break;
		case (version_compare($wp_version, '2.9', '>=')) :
			include (MP_ABSPATH . 'mp-includes/wp_pluggable.2.9.php');
		break;
		default :
