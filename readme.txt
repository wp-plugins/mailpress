...
For upgrade to 1.1.5 or above from lower versions, deactivate and reactivate the plugin.
...
**1.4**  		2008/07/14 
					* bug in IP country Geolocation				(mp-includes/MP_User.class.php)
					* introducing manage link to allow comment subscribers 
					  to unsubscribe from one or several post 		(mp-includes/mp-mail-links.php)
