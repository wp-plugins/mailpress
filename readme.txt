...
* NEW ! MailPress_upload_media is an add-on for MailPress to use upload media wordpress facilities for images.
* NEW ! MailPress_connection_sendmail is an add-on for MailPress to replace default SMTP connection by SendMail connection.
