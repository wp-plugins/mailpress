...
* Changes :
 - some deprecated 'get_bloginfo' removed 
 - basic functions to connect to & disconnect from db added in MP_Mail
 - connect to & disconnect from db added
 - some web host (1and1) do not accept email or empty string in the to name (thanks Markus !)
 - ready for wp 2.8 
