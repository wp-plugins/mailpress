...
Last release for WordPress 2.6.x

== Description ==

**FOR WORDPRESS 2.7 DOWNLOAD MAILPRESS 2.0 AT http://www.mailpress.org  !**
...
* MailPress_deregister_scripts is an add-on for MailPress to remove scripts from MailPress Pages and avoid potential plugin conflicts.
...
* new add-on mailpress_deregister_scripts replacing mailpress_remove_prototype. 
All scripts in a xml file (scripts.xml) can be "deregistered" for all mailpress pages.
...
* Now you can change the subscriber subscriptions in Users > MailPress or MailPress > Users 
* Ability to subscribe to mailing lists (with mailpress_mailing_lists)
* Ability to set the subscription in WP register form (with mailpress_sync_wordpress_user)
* Ability to see logs (with mailpress_view_logs) (WPMU compatible !!)

* new importer 'subscribe to comments' (with mailpress_import)

* Some changes on class MP_Newsletter 
