...
&nbsp;
					      ...
					      <div style="margin:0;clear:both;padding:10px 5px;color:#333;font-family:Verdana,Tahoma,Arial,Serif;font-size:0.76em;">
<?php printf( 'You are now a subscriber of : %s', "<a style='color:#000;' href='" . get_option('siteurl') . "'>" . get_option('blogname') . "</a>" ); ?>
						</div>
				      </div>
