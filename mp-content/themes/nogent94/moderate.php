...
<?php $this->get_header() ?>
			<div>
				<table style='width:100%;border:none;'>
					<tr>
						<td style='float:left;margin:0;padding:0pt 0pt 20px 45px;width:100%;text-align:left;color:#333333;font-family:Verdana,Sans-Serif;'>
...
echo ("<a href='" . get_permalink($this->args->c->post_ID ) . "'>" . __('You can see all comments on this post here: ')          . "</a><br/>\n<br/>\n");
