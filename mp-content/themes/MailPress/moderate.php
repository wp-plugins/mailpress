...
echo ("<a style='color:#6D8C82;font-family: verdana,geneva;font-weight:bold;' href='" . get_permalink($this->args->c->post_ID ) . "'>" . __('You can see all comments on this post here: ')          . "</a><br><br>");
