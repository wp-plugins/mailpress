...
function wp_mail( $to, $subject, $message, $headers = '' ) {
	...
	$args->toemail  = $to;
	$args->toname   = MP_Mail::display_name($args->toemail);
...
function wp_notify_postauthor($comment_id, $comment_type='') {
	...
	$args->toname     = MP_Mail::display_name(stripslashes($user->display_name));
	$args->subject 	= $subject;
...
function wp_new_user_notification($user_id, $plaintext_pass = '') {
	...
	$args->toemail 	= $admin->user_email;
	$args->toname     = MP_Mail::display_name(stripslashes($admin->display_name));
