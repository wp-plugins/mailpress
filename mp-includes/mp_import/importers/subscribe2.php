...
class MP_import_subscribe2 extends MP_Import_abstract
{
	function __construct() 
	{
		$this->importer 		= 'subscribe2';
		$this->importer_text 	= __('Import data from <strong>subscribe2</strong> plugin.', 'MailPress');
		$this->importer_header 	= __('Import from Subscribe2', 'MailPress');
		parent::__construct();
