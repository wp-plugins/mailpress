<?php
require_once(MP_TMP . 'mp-admin/class/MP_Import_abstract.class.php');
class MP_import_subscribe_to_comments extends MP_Import_abstract
{
	function __construct() 
	{
		$this->importer 		= 'subscribe_to_comments';
		$this->importer_text 	= __('Import data from <strong>subscribe to comments</strong> plugin.', 'MailPress');
		$this->importer_header 	= __('Import from Subscribe to comments', 'MailPress');
		parent::__construct();
