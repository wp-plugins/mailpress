		...
		<div style='padding:6px;text-align:right;'>
			<div style='position:relative;'>
				<div style='float:left'>
					<div id='MailPress_post_test_loading' style='position:absolute;opacity:0;filter:alpha(opacity=0);'><img src='<?php echo get_option('siteurl') . '/' . MP_PATH . 'mp-admin/images/loading_small.gif'; ?>' style='padding-right:5px;' /><?php _e('Sending ...', 'MailPress'); ?></div>
