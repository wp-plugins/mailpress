...
class MP_Admin_screen extends MP_abstract
{
...
//// Screen Options ////
	...
	public static function contextual_help($x) 
	{
		...
		$contextual_help = '';
		$contextual_help .= "<small style='float:right;padding:10px 15px 0;'><a href='http://www.mailpress.org' target='new'>" . __('(Please Donate)', 'MailPress') . '</a></small>';
