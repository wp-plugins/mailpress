...
MailPress::require_class('Ip_infosniper');	$MP_Ip_infosniper = new MP_Ip_infosniper();
MailPress::require_class('Ip_ipinfodb');		$MP_Ip_ipinfodb 	= new MP_Ip_ipinfodb();
MailPress::require_class('Ip_hostip');		$MP_Ip_hostip 	= new MP_Ip_hostip();
MailPress::require_class('Ip_geoplugin');		$MP_Ip_geoplugin 	= new MP_Ip_geoplugin();
?>