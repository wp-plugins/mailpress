...
class MP_Forms_templates
{
	...
	function __construct()
	{
		...
		if ($dir) 
			...
			{
//if (MailPress::debug) { global $mp_debug_log; if (isset($mp_debug_log)) $mp_debug_log->log(" คค loading $file ..." ); }
				$f = file_get_contents("$root/$file");
//if (MailPress::debug) { global $mp_debug_log; if (isset($mp_debug_log)) $mp_debug_log->log(" คคค loaded $file" ); }
