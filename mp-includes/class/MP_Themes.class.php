 ...
 */
	...
	{
		return apply_filters('MailPress_stylesheet', get_option('MailPress_stylesheet'));
	}
	...
	{
		return apply_filters('MailPress_template', get_option('MailPress_template'));
	}
...
// Resolve theme dependencies.
	...
	{
		return apply_filters('MailPress_theme_root_uri', get_option('siteurl') . "/" . MP_PATH  . "mp-content/themes", get_option('siteurl'));
	}
