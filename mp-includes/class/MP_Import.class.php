<?php 
abstract class MP_Import
{
	const bt = 133;

	function __construct() 
	{
		$this->register($this->importer, $this->importer, $this->importer_text, array (&$this, 'dispatch'));
		$this->trace_header = false;
	}

	function register( $id, $name, $description, $callback ) 
	{
		global $mp_importers;
