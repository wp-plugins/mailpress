...
// recipients
	...
	{
		$draft_dest = array (	'1' => __('active blog','MailPress'), 
						'2' => __('active comments','MailPress'), 
						'3' => __('active blog + comments','MailPress'), 
						'4' => __('active + not active','MailPress') 
					  );
		return array_merge(apply_filters('MailPress_mailing_lists',array(''  => '&nbsp;')),$draft_dest);
	}
...
// url's
		...
		$edit_url = (has_filter('MailPress_edit_user_url')) ? MP_Admin::url(apply_filters('MailPress_edit_user_url',$edit_url,$user->id),false,$url_parms) : $write_url ;
