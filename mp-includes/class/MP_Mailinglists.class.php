...
class MP_Mailinglists extends MP_abstract
{
...
////  Object  ////
	...
	{
		$object_id = (int) $object_id;
		if (!is_array($object_terms) || 0 == count($object_terms) || empty($object_terms)) $object_terms = array(get_option('MailPress_default_mailinglist'));
...
////  Layouts  ////
	...
	{
		self::require_class('Mailinglists_Walker_Dropdown');
	...
	{
		self::require_class('Mailinglists_Walker_Array');
