...
//if (defined('MP_SCRIPT_DEBUG')) { global $mp_debug_log; if (isset($mp_debug_log)) $mp_debug_log->log(" คค loading " . basename($file) . " ..." ); }
		require_once($file);
//if (defined('MP_SCRIPT_DEBUG')) { global $mp_debug_log; if (isset($mp_debug_log)) $mp_debug_log->log(" คคค loaded " . basename($file) ); }
	}
}
?>