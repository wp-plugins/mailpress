<?php
class MP_Actions extends MP_abstract
{
...
////  STANDARD  ////
	...
	public static function tracking()
	{
		...
		self::mp_redirect(get_option('home'));
		die();
	}
...
////  SUBSCRIPTION FORM  ////
	...
	public static function add_user_fo() {
		...
		ob_end_clean();
		header('Content-Type: text/xml');
		echo "<?xml version='1.0' standalone='yes'?><wp_ajax><message><![CDATA[$message]]></message><email><![CDATA[$email]]></email><name><![CDATA[$name]]></name></wp_ajax>";
		die();
	}
