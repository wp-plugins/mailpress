...
class MP_Xml
{
	...
	function getElement($dom_element, $object_element) 						// from http://eusebius.developpez.com/php5dom/
	{
	...
	function setElement($dom_document, $object_element, $dom_element) 			// from http://eusebius.developpez.com/php5dom/
	{
