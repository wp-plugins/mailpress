...
// for javascript
	...
	function register_scripts() {
		...
		wp_localize_script( 'mp-postbox', 'postboxL10n', array( 'requestFile' => get_option('siteurl') . '/wp-content/plugins/' . MP_FOLDER . '/mp-includes/action.php' ) );
		...
		wp_localize_script( 'mp-lists', 'wpListL10n', array( 'url' => get_option( 'siteurl' ) . '/wp-content/plugins/' . MP_FOLDER . '/mp-includes/action.php' ) );
	}
