...
// wp_redirect
		if ((MP_FOLDER . '/mp-admin/mails.php' == $page) && !empty( $_POST['delete_mails'] )) return;
		if ((MP_FOLDER . '/mp-admin/users.php' == $page) && !empty( $_POST['delete_users'] )) return;
		$oldmenu = (isset($mp_general['menu'])) 		? $mp_general['menu'] : false;
		$newmenu = (isset($_POST['general']['menu']))	? $_POST['general']['menu'] : (isset($mp_general['menu'])) ? $mp_general['menu'] : false;
		if ((MP_FOLDER . '/mp-admin/settings.php' == $page) && ($newmenu !== $oldmenu)) return;
