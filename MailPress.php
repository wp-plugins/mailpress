...
// for admin plugin pages
		...
		define ('MailPress_page_edit',	MailPress_page_mails . '&file=mail-new');
...
<p>
	<label for="MailPress-title">
		<?php _e('Title:'); ?> 
		<input class='widefat' id="MailPress-title" name="MailPress-title" type="text" value="<?php echo $title; ?>" />
	</label>
	<br/>
	<label for="MailPress-title">
